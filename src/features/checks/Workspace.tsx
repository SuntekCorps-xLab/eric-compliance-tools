...
import {
  ...
  type CopyrightDetectionResult,
  type DetectionRisk,
  type DesignDetectionResult,
  type GraphicTrademarkDetectionResult,
  type InventionDetectionResult,
  type LiveDetectionResult,
  type PolicyDetectionResult,
  type RestrictedProductDetectionResult,
  type TrademarkDetectionResult,
  type TrademarkRecordStatus,
  type TrademarkRegistrationRecord,
...
function PolicyResults({ result }: { result: PolicyDetectionResult }) {
...
function InventionResults({ result }: { result: InventionDetectionResult }) {
  return (
...
function DesignResults({ result }: { result: DesignDetectionResult }) {
  return (
...
function GraphicTrademarkResults({ result }: { result: GraphicTrademarkDetectionResult }) {
  return (
...
function CopyrightResults({ result }: { result: CopyrightDetectionResult }) {
  return (
...
function RestrictedProductResults({ result }: { result: RestrictedProductDetectionResult }) {
  return (
